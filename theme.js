//config code
var company_name = "Pilgrim's Global";
// .header-outer height
...
$(document).ready(function() {
    ...
    $('.header__menu-mobile-button').click(function() {
        ...
        $('body').toggleClass('scroll menu-active');
    ...
    if ($('.video-carousel__item').length > 1) {
        $('.video-carousel-inner').slick({
            accessibility   : true,
            arrows          : true,
            prevArrow       : '<span class="video-carousel-inner__nav video-carousel-inner__nav--prev"><i class="fa-solid fa-chevron-left"><span class="show-for-sr">Previous video</span></i></span>',
            nextArrow       : '<span class="video-carousel-inner__nav video-carousel-inner__nav--next"><i class="fa-solid fa-chevron-right"><span class="show-for-sr">Next video</span></i></span>',
            dots            : true,
            infinite        : true
        });
    }
